 <template>
	<div class="order_page">
        <head-top head-title="中華料理・お粥" go-back='true'></head-top>
                ...
                <section class="order_item_right">
                    <section class="order_basket">
                        ...
                        <section @click="showDetail(item)">
                            <img :src="imgBaseUrl + 'chinese/' + item.image_path" class="order_amount"/>
                        </section>
      ...
      data(){
        ...
        methods: {
            ...
            async initData(){
                ...
                this.tablelist = await defaultFoodList("中華料理", "お粥");
            ...
            showDetail(item){
                ...
                this.qriouslyimgs=imgBaseUrl + 'chinese/' + item.image_path;
            },
            //确认
            async outLogin(){
                this.show = false;
            ...
            async add(){
                ...
                for (var i = 0;i < food_add.length; i++) {
                    ...
                    var params = {
                        ...
                        image_path: 'chinese/' + food_add[i].image_path,
