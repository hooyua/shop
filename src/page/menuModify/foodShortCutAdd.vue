<template>
    <div class="profile_page">
        <head-top go-back='true' head-title="操作の選択"></head-top>
        <section>
            <section class="profile-number">
            </section>
            <section class="profile-1reTe">
                <router-link to='/foodAddByType' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.customfoodadd' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>カスタマイズで料理を追加</span>
            ...
            <section class="profile-1reTe">
                <router-link to='/foodDefaultAdd' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.defaultfoodadd' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>デフォルトで料理を追加</span>
                        <span class="myorder-divsvg">
                            <svg fill="#bbb">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                            </svg>
        ...
        async linkmenuModify(){
            ...
            if(this.restaurant_id){
                ...
                if(this.menuList != ''){
                    ...
                    this.showAlert = true;
                    this.alertText = 'まずメニューに追加してください';
                }
            }else{
                this.showAlert = true;
                this.alertText = '店舗情報を取得失敗';
