<template>
    <div class="profile_page">
        <head-top go-back='true' head-title="種類の追加、削除"></head-top>
        <section>
            ...
            <section class="profile-1reTe">
                <router-link to='/foodTypeAdd' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.customtypeadd' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>カスタマイズで種類を追加</span>
            ...
            <section class="profile-1reTe">
                <router-link to='/foodTypeDefaultAdd' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.defaulttypeadd' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>デフォルトで種類を追加</span>
                        <span class="myorder-divsvg">
                            <svg fill="#bbb">
                                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
                            </svg>
            ...
            <section class="profile-1reTe">
                <router-link to='/foodTypeDelList' class="myorder">
                    <aside>
