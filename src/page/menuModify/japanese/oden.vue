 <template>
	<div class="order_page">
        <head-top head-title="和食・おでん" go-back='true'></head-top>
                ...
                <section class="order_item_right">
                    <section class="order_basket">
                        ...
                        <section @click="showDetail(item)">
                            <img :src="imgBaseUrl + 'japanese/' + item.image_path" class="order_amount"/>
                        </section>
      ...
      data(){
        ...
        methods: {
            ...
            async initData(){
                ...
                this.tablelist = await defaultFoodList("和食", "おでん");
            ...
            showDetail(item){
                ...
                this.qriouslyimgs=imgBaseUrl + 'japanese/' + item.image_path;
            },
            //确认
            async outLogin(){
                this.show = false;
            ...
            async add(){
                ...
                for (var i = 0;i < food_add.length; i++) {
                    ...
                    var params = {
                        ...
                        image_path: 'japanese/' + food_add[i].image_path,
