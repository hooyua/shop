 <template>
	<div class="order_page">
        <head-top head-title="中華料理の種類を追加" go-back='true'></head-top>
...
<script>
    ...
    import {getMenu, addCategorys, defaultTypeList} from 'src/service/getData'
      ...
      data(){
        ...
        methods: {
            ...
            async initData(){
                ...
                var tmpList = await defaultTypeList("中華料理");
