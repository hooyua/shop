<template>
    <div class="profile_page">
        <head-top go-back='true' head-title="一括処理の選択"></head-top>
        <section>
            <section class="profile-number">
            </section>
            <section class="profile-1reTe">
                <router-link to='/foodPuton' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.lotputon' class="icon_style">
                    </aside>
            ...
            <section class="profile-1reTe">
                <router-link to='/foodPutoff' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.lotputoff' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>売り切れ</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/foodRecommend' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.lotrecommend' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>推薦</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/foodNoRecommend' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.lotnorecommend' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>推薦キャンセル</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/foodDelete' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.typedel' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>削除</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/foodListByDiscount' class="myorder">
                    <aside>
                        <img :src='GLOBAL.defaults.lotdiscount' class="icon_style">
                    </aside>
                    <div class="myorder-div">
                        <span>割引</span>
                        <span class="myorder-divsvg">
