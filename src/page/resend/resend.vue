<template>
    <div class="restContainer">
        <head-top head-title="も一度送信" goBack="true"></head-top>
        <form class="restForm">
...
<script>
    ...
    import {resend} from 'src/service/getData'
    ...
    export default {
        ...
        methods: {
            ...
            async resetButton(){
                ...
                let res = await resend(this.userAccount);
                if (res.message) {
                    if(res.message == 'no account'){
                        this.showAlert = true;
                        this.alertText = 'ユーザーが存在しません！';
                        return
                    }
                    if(res.message == 'account is actived'){
                        this.showAlert = true;
                        this.alertText = 'アカウントがアクティブになりました！';
                        return
                    }
                    this.showAlert = true;
