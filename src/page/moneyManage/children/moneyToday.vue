 <template>
	<div class="rating_page">
        <head-top head-title="最近５日間の売り上げ金額" go-back='true'></head-top>
	<section>
        <section class="detail_container">
            <p>時間：</p>
            <datepicker type="day" v-model="tmp_datetime" @select-time="initData" :placeholder="tmp_datetime" class="datepicker"></datepicker>
        </section>
	</section>
    <div id="app">
            ...
            async initData(){
                ...
                if(this.shopOpenList.length > 0){
                    for(var i=0; i<5; i++){
                        ...
                        date.setDate(date.getDate()+1);//往后算1天，年份、月份会自动变化
                        ...
                        if(this.total_amounts == 0){
                            this.datas.push({name: m + "-" + d, value: ''}); 
                        }else{
                            this.datas.push({name: m + "-" + d, value: this.total_amounts});
                        }
                    }
