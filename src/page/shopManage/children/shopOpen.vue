 <template>
	<div class="restContainer">
        <head-top head-title="営業" go-back='true'></head-top>
        <form class="restForm">
            ...
            <div class="alet_container">
                ...
                <section class="cover-content">
                    ...
                    <div class="sa-botton">
                        ...
                        <div class="confrims" @click="openshop">確認</div>
                    </div>
                </section>
            </div>
        </section>
                ...
                if (!this.userInfo.user_id) {
                    ...
                    try{
                        ...
                        if (res.status >= 1) {
                            this.shows = false;
                            this.showAlert = true;
                            this.alertText = '店舗営業成功';
                        }
                    }catch (error) {
                        this.shows = false;
                        this.showAlert = true;
                        this.alertText = '店舗営業失敗';
