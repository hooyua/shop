<template>
    <div class="profile_page">
        <head-top head-title="注文履歴"></head-top>
        <section>
            <section class="profile-number">
            </section>
            <section class="profile-1reTe">
                <router-link to='/today' class="myorder">
                    <aside>
                        <img :src="GLOBAL.defaults.today" class="img_style">
                    </aside>
            ...
            <section class="profile-1reTe">
                <router-link to='/yesterday' class="myorder">
                    <aside>
                        <img :src="GLOBAL.defaults.week" class="img_style">
                    </aside>
                    <div class="myorder-div">
                        <span>昨日の注文</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/order' class="myorder">
                    <aside>
                        <img :src="GLOBAL.defaults.Recentmonth" class="img_style"> 
                    </aside>
                    <div class="myorder-div">
                        <span>昨日までの注文</span>
                        <span class="myorder-divsvg">
            ...
            <section class="profile-1reTe">
                <router-link to='/orderTable' class="myorder">
                    <aside>
                        <img :src="GLOBAL.defaults.merge" class="img_style"> 
                    </aside>
                    <div class="myorder-div">
                        <span>注文をまとめる</span>
                        <span class="myorder-divsvg">
