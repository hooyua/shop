...
<script>
    ...
    import {getOpenShop, getyesterdayOrderList} from 'src/service/getData'
        ...
        methods: {
            ...
            async initData(){
                ...
                if(this.shopOpenList.length > 0){
                    let res = await getyesterdayOrderList(this.shopOpenList[0].id, this.tmp_datetime, this.offset, this.limit, this.order_id);
                    this.orderList = [...res];
            ...
            async loaderMore(){
                ...
                //获取信息
                let res = await getyesterdayOrderList(this.shopOpenList[0].id, this.tmp_datetime, this.offset, this.order_id);
